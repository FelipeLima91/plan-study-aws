export function Footer() {
  return (
    <footer className="footer bg-base-300 text-base-content py-4 px-4 sm:py-6 sm:px-8 mt-12 flex flex-col sm:flex-row items-center justify-between shadow-sm rounded-box gap-2 sm:gap-0">
      <p className="text-xs sm:text-sm font-medium m-0 text-center sm:text-left">
      ...
      <nav className="flex items-center justify-center gap-4 sm:gap-6">
        ...
        >
          <svg
            ...
            height="20"
            viewBox="0 0 24 24"
            className="fill-current sm:w-[22px] sm:h-[22px]"
          >
